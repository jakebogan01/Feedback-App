...
<div class="flex flex-col justify-between bg-white py-6 px-5 h-[15.6875rem] rounded-[0.625rem] text-13 {currentStatus !== "" ? borderStyles : ""}" data-sveltekit-preload-data="hover">
