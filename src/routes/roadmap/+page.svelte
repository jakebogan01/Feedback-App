...
{#if $preferences[1]}
     <div class="flex flex-col justify-between bg-[#F7F8FE] dark:bg-[#0F172A] md:pt-14 md:px-10" style="height: -webkit-fill-available; min-height: 100dvh;">
          <div class="w-full">
               ...
               {#if suggestions}
                    <main class="max-w-[69.375rem] mx-auto md:mt-8 1440:mt-12">
