...
{#if $preferences[1]}
     <div class="bg-[#F7F8FE] dark:bg-[#0F172A]">
     ...
     <span class="absolute bottom-0 left-1/2 -translate-x-1/2 block w-full text-center text-gray-300 text-sm pb-10">© 2023 Lead Marvels, Inc. All rights reserved.  <a href="https://leadmarvels.com" class="underline">Home Site</a>.  <a href="https://lmdashboard.com/nova/dashboards/main" class="underline">Dashboard</a></span>
{/if}